...
export const CalculatorMontos = () => {
    ...
    const { form, updateForm } = useMejoravit();
        ...
        <div className="border border-border-soft rounded-xl p-6 bg-bg-light shadow-sm max-w-md mx-auto">
            ...
            <form onSubmit={calcularMonto} className="space-y-4">
                <div className="flex flex-col gap-1 w-full">
                    <label className="text-sm text-text-primary font-semibold">Ingrese Monto:</label>
                    <input
                        type="number"
                        step="0.01"
                        value={monto}
            ...
            {resultado !== null && (
                <div className="mt-6 border-t border-border-soft pt-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between bg-white border border-border-soft rounded-lg p-3 gap-3">
                        <span className="font-extrabold text-lg text-text-primary self-start sm:self-auto">
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                            <button
                                ...
                                className={`flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium transition-colors flex-1 sm:flex-auto ${copiado
                        ...
                        <button
                            onClick={handleUsarEnCredito}
                            className="bg-primary hover:opacity-90 text-white flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-md text-sm font-medium transition-colors flex-1 sm:flex-auto w-full"
                        >
                            <span>Usar en Crédito</span>
                            <span>→</span>
                        </button>
                    </div>
                </div>
